...
![herdr-yazi open in a split pane showing Yazi file explorer](assets/hero-windows.png)
...
Originally created by [speardragon](https://github.com/speardragon) as `speardragon/herdr-yazi`. This fork adds native Windows support via herdr's v0.8+ pane spawning API.
